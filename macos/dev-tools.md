...
aqua:securego/gosec                            2.26.1    ~/.config/mise/config.toml  latest
ast-grep                                       0.42.1
ast-grep                                       0.43.0    ~/.config/mise/config.toml  latest
awscli                                         2.34.38
awscli                                         2.34.58
awscli                                         2.34.59   ~/.config/mise/config.toml  latest
bat                                            0.26.1    ~/.config/mise/config.toml  latest
checkov                                        3.2.524
checkov                                        3.2.530   ~/.config/mise/config.toml  latest
cloud-sql-proxy                                1.38.0
cloud-sql-proxy                                2.21.3    ~/.config/mise/config.toml  latest
cloudflared                                    2026.3.0
cloudflared                                    2026.5.2  ~/.config/mise/config.toml  latest
...
firebase                                       15.15.0
firebase                                       15.19.0   ~/.config/mise/config.toml  latest
fzf                                            0.71.0
fzf                                            0.73.1    ~/.config/mise/config.toml  latest
gh                                             2.91.0
gh                                             2.93.0    ~/.config/mise/config.toml  latest
github:go-acme/lego                            4.35.2
github:go-acme/lego                            5.2.0     ~/.config/mise/config.toml  latest
...
go:golang.org/x/tools/cmd/goimports            0.45.0    ~/.config/mise/config.toml  latest
go:golang.org/x/vuln/cmd/govulncheck           1.1.4
go:golang.org/x/vuln/cmd/govulncheck           1.3.0     ~/.config/mise/config.toml  latest
...
node                                           22.17.1
node                                           22.22.3   ~/.config/mise/config.toml  22
npm                                            10.9.2
npm                                            11.14.1
npm:@openapitools/openapi-generator-cli        2.31.1
npm:@openapitools/openapi-generator-cli        2.34.0    ~/.config/mise/config.toml  latest
npm:@redocly/cli                               2.22.1
npm:@redocly/cli                               2.31.5    ~/.config/mise/config.toml  latest
...
packer                                         1.15.2
packer                                         1.15.3    ~/.config/mise/config.toml  latest
pnpm                                           10.11.1
pnpm                                           10.33.2
pnpm                                           11.5.0    ~/.config/mise/config.toml  latest
...
temporal                                       1.30.4
temporal                                       1.31.0    ~/.config/mise/config.toml  latest
terraform                                      1.14.6    ~/.config/mise/config.toml  1.14
tflint                                         0.50.3
tflint                                         0.62.1    ~/.config/mise/config.toml  latest
...
wrangler                                       4.85.0
wrangler                                       4.95.0    ~/.config/mise/config.toml  latest
yamllint                                       1.38.0    ~/.config/mise/config.toml  latest
yq                                             4.52.4
yq                                             4.53.2    ~/.config/mise/config.toml  latest
```

## npm globals

```
/Users/arbeitandy/.local/share/mise/installs/node/22.22.3/lib
├── corepack@0.34.6
└── npm@10.9.8
